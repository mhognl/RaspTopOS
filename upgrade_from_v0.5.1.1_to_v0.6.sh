...
rm -rf /os /recovery /usr/lib/cgi-bin/* && apt update && apt install git apache2 openssh-server sudo net-tools libapache2-mod-perl2 libcgi-session-perl libapache-htpasswd-perl -y
a2enmod cgi
