document.title="RaspTop OS v0.7";
...
if (location.search=="?q=verinfo") {
	...
	document.write("<p><b>Version: </b>0.7</p>");
	document.write("<p><b>Last Updated: </b>29-11-2018</p>");
...
if (location.search=="?q=theming") {
	...
	document.write("<p><button onclick='themingbg0()'><img src='/img/bg_current.jpg' width='150' height='150'><br>0. Africa (Default)</button><button onclick='themingbg1()'><img src='/img/bg_desktop1.jpg' width='150' height='150'>1. Jungle Bridge<br></button></p>");
	document.write("<p><button onclick='themingbg2()'><img src='/img/bg_desktop2.jpg' width='150' height='150'><br>2. Car</button><button onclick='themingbg3()'><img src='/img/bg_desktop3.jpg' width='150' height='150'>3. Stone<br></button></p>");
	document.write("<p><button onclick='themingbg5()'><img src='/img/bg_desktop5.jpg' width='150' height='150'><br>5. Ocean</button><button onclick='themingbg6()'><img src='/img/bg_desktop6.jpg' width='150' height='150'>6. Space<br></button></p>");
