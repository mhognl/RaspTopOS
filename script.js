document.title="RaspTop OS v0.5.2";
...
if (location.search=="?q=verinfo") {
	...
	document.write("<p><b>Version: </b>0.5.2</p>");
	document.write("<p><b>Last Updated: </b>15-11-2018</p>");
...
if (location.search=="?q=upmng") {
	...
	document.write("<p><button onclick='upos()'>Update System</button><button onclick='upos()'>Update OS</button></p>");
	document.write("</div>");
}
